								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="/marks_notification" class="badge badge-pill badge-warning mr-auto my-auto float-left">قراءة جميع الرسائل</a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">هناك {{ auth()->user()->unreadNotifications->count()}}  اشعارات </p>
									</div>
									<div class="main-notification-list Notification-scroll">
                                        @foreach (auth()->user()->unreadNotifications as $notification)
                                            <a class="d-flex p-3 border-bottom" href="{{url('InvoiceDetails/edit',$notification->data['id'])}}">
