    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/report_custom_search" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><a href="{{url('InvoiceDetails/edit',$invoice->id)}}">{{$invoice->invoice_number}}</a></td>                                        <td>{{ $invoice->invoice_Date }}</td>
